...
<body>
        ...
        <div class="col-md-4">
                            ...
                            <section class="card">
                                <div class="card-header user-header alt bg-dark">
                                    <div class="media">
                                        <div class="media-body">
                                            <h2 class="text-light display-6">{{$produit->libelle}}</h2>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <a href="#"> <i class="fa fa-group"></i> Client :  <span class="badge badge-primary pull-right">{{ $client->nom }} {{ $client->prenom }}</span></a>
                                        @endif
                                        @endforeach
                                    </li>
                                    <li class="list-group-item">
                                        <a href="#"> <i class="fa fa-tasks"></i> Statut <span class="badge badge-danger pull-right">{{$produit->status}}</span></a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="#"> <i class="fa fa-bell-o"></i> Date début <span class="badge badge-success pull-right">{{$produit->date_debut}}</span></a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="#"> <i class="fa fa-bell-o"></i> Date fin <span class="badge badge-warning pull-right r-activity">{{$produit->date_fin}}</span></a>
                                    </li>
                                </ul>
            ...
            <div class="progress mb-2">
                <div class="progress-bar bg-info" role="progressbar" style="width: {{ $produit->pourcentage }}%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">{{ $produit->pourcentage }}%</div>
            </div>
        </div>
